 ...
 * @since 2011-11-07
 */
class Aoepeople_Phpunit_Printer_VerboseResultPrinter extends PHPUnit_TextUI_ResultPrinter
{
    ...
    {
        $message = sprintf("%s  INCOMPLETE: %s (Duration: %s sec)\n", str_repeat('  ', $this->level), str_replace("\n", " ", $e->getMessage()), $this->getDuration());
